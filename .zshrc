...
plugins=(brew chucknorris command-not-found common-aliases dirhistory dnf docker gem git kubectl lol npm pep8 pip python screen sdk vundle web-search zsh-autosuggestions)
# ssh-agent
